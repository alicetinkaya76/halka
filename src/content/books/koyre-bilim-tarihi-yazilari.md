...
halka_metadata:
  ...
  sira_no: 22
  status: "sirada"
  ek_kategori_aciklama: "Halka ana müfredatının dışında, bilim-tarihçilik kanonu kategorisinde tamamlayıcı okuma. Ana müfredattaki Westfall #15 (Modern Bilimin Oluşumu), Kuhn #17 (Bilimsel Devrimlerin Yapısı) ve Wootton #18 (Bilimin İcadı) kitaplarıyla yoğun-akademik diyalog içinde okunur. Burke (Bilginin Toplumsal Tarihi), Sayılı (Mısırlılarda ve Mezopotamyalılarda Matematik, Astronomi ve Tıp) ve Whitfield (Batı Biliminin Dönüm Noktaları) ile birlikte ek-kitap-grubunu oluşturur."
...
relationships_to_other_books:
  ...
  # === Halka 3. Dönem (12-18) Bilim Devrimi figürleri/yorumları ile ileri-cross-ref'ler ===
  ...
  - book: "kuhn-bilimsel-devrimlerin-yapisi"
    relation: "tematik_tamamlayici"
    note: "Kuhn (Halka #17, 3. dönem-yapısal-kapanışı + 4. dönem-köprü-konumu) *Bilimsel Devrimlerin Yapısı*'nın önsözünde Koyré'yi 'ustam' olarak adlandırır. Koyré'nin 'kavramsal-kopuş' (rupture conceptuelle) kavramı Kuhn'un 'paradigma-değişimi' kavramının doğrudan-felsefi-öncülüdür. **Halka'nın en güçlü akademik-miras cross-ref'i**: Koyré 1939 *Études galiléennes* (kavramsal-kopuş ön-formülasyonu) → Kuhn 1962 *Yapı* (paradigma-değişimi-akademik-genelleme). Halka grup-okumasında Koyré-Kuhn çift-okuması bilim-tarihçiliğin 20. yy felsefi-omurgasını oluşturur."

  - book: "wootton-bilimin-icadi"
    relation: "kismen_celisir"
    note: "Wootton'ın *Bilimin İcadı: Bilim Devrimi'nin Yeni Bir Tarihi* (Halka #18, 3. dönem-akademik-tarihçi-yenidoğuş-katmanın merkez-vakası) revizyonist Bilim Devrimi okuması Koyré-Westfall klasik-içselci anlatısına disiplinli yan-yenidoğuş sunar. Wootton'ın tezi: Bilim Devrimi 1572 (Tycho'nun nova-vakası) ile 1704 (Newton *Opticks*) arası daha-uzun ve daha-çoklu-figürlü bir süreçtir; Galileo-Newton merkezliliği dört-figür-katman-anatomisinde (şehitler-kahramanlar-propagandacılar-emekçiler) yapısal yan-yana-yenidoğuşa açılır. Halka 3. dönem-tarihçi-zincirin (Koyré 1939 → Westfall 1980 → Kuhn 1962-1969 → Wootton 2015) 76-yıllık akademik-yenidoğuş-vakası — Halka grup-okumasında Koyré (1939 kanonik-formülasyon) ve Wootton (2015 revizyonist-yenidoğuş) Bilim Devrimi tarihyazımının kuşaklar-arası karşılaşmasını sunar."

  # === Halka 4. Dönem (Karşılaştırmalı Sentezler) ile ileri-cross-ref-açıklığı ===
  # Halka 4. dönem ana-müfredatı v0.23 itibariyle henüz açılmadı — Halka #19+ konum-noktasında değerlendirilecek.
  # Ek-kategoride yöntemsel-akrabalık-aday-zincir-konumlamaları akademik-müfredat-genişlemesinin disiplinli yan-zemininde değerlendirilir:
  # - Sarton *Bilim Tarihi Araştırmalarında Yöntem* (bilim-tarihçilik metodu, Amerikan-kurucu-figür 1936 *Isis*),
  # - Gavroglu *Bilimlerin Geçmişinden Tarih Üretmek* (eleştirel-eklemlenme tezi),
  # - Ronan *Bilim Tarihi* (panoramik-bilim-kültür-serüven anlatısı, çoklu-medeniyet-eksenli yaklaşım),
  # - Patricia Fara *Bilim: Dört Bin Yıllık Tarih* (Halka v0.X-mevcut atomik, Halka 4. dönem-açılış-aday-vakası).
  # Bu yan-zemin-figürlerinin Koyré'yle yöntemsel-akrabalıkları (Whig-tarihçiliği reddi, içselci-dışsalcı-mixed eksen-tartışması, panoramik-pedagojik vs. teknik-felsefi yan-yan-konumlaması) Halka 4. dönem-müfredatı açıldığında disiplinli akademik-yan-yana-konumlamada işlenir.
...
Halka'nın ana müfredatında *Bilim Tarihi Yazıları 1* doğrudan yer almaz; **Ek Kitaplar - Tamamlayıcı Okumalar** kategorisinde bilim-tarihçilik kanonunun zorlu-akademik-kutbu olarak konumlanır. Halka 1. Dönem (Genel Bilim Tarihi ve Doğu'nun Katkıları, #1-4: Fara, Freely, Goody-R, Hobson) bilim tarihi-yazımına genel girizgâh sundu; 2. Dönem (Doğu Bilim Geleneği ve İslam Bilimi, #5-11: Goody-BD, Starr, Pedersen, Berkey, Sezgin, Lyons, Gutas) İslam-Doğu-bilim-zincirinin akademik-haritalanmasını yaptı; 3. Dönem (Batı Bilim Devrimi, #12-18: Gleick-Newton, Wulf-Humboldt, Isaacson-Franklin, Westfall, Isaacson-Einstein, Kuhn, Wootton) bilim devrimi merkez-figürlerinin biyografik ve akademik anlatısı + akademik-meta-felsefe + akademik-tarihçi-yenidoğuş katmanlarını çift-eksende sunar; **Halka 3. dönem-yapısal-kapanışı** Halka #17 Kuhn-meta-felsefe-yapılaşması ile Halka #18 Wootton-tarihçi-yenidoğuş çift-konumda olur. **4. Dönem (Karşılaştırmalı Sentezler)** v0.23 itibariyle henüz açılmadı — Halka #19+ konum-noktasında değerlendirilecek; Patricia Fara *Bilim: Dört Bin Yıllık Tarih* (Halka v0.X-mevcut atomik) Halka 4. dönem-açılış-aday-vakası olarak konumlanır, Sarton-Gavroglu-Ronan gibi yöntemsel-akrabalık-aday-zincir-figürleri akademik-müfredat-genişlemesinin disiplinli yan-zemininde değerlendirilir. Koyré'nin Halka'daki yeri ek-kategoride Burke (Bilginin Toplumsal Tarihi), Sayılı (Mısırlılarda ve Mezopotamyalılarda Matematik, Astronomi ve Tıp) ve Whitfield (Batı Biliminin Dönüm Noktaları) ile birlikte tamamlayıcı okuma grubudur.
...
Halka 3. dönem-yapısal-kapanışındaki çift-konum (Halka #17 Kuhn-meta-felsefe + Halka #18 Wootton-tarihçi-yenidoğuş) Koyré ile yoğun-akademik diyalog içindedir: Kuhn #17 *Bilimsel Devrimlerin Yapısı*'nın önsözünde Koyré'yi 'ustam' olarak adlandırır (kavramsal-kopuş → paradigma-değişimi felsefi-mirası); Wootton #18 *Bilimin İcadı* (2015) Koyré-Westfall klasik-içselci anlatısının 21. yy-revizyonist-yenidoğuş-vakası — 1572-1704 paranıyla daha-uzun-yapılaşma + dört-figür-katman-anatomisi (şehitler-kahramanlar-propagandacılar-emekçiler) Koyré-Galileo-Newton-merkezliliğinin disiplinli yan-yenidoğuşu. Halka 3. dönem-tarihçi-zincirin (Koyré 1939 → Westfall 1980 → Kuhn 1962-1969 → Wootton 2015) **76-yıllık yenidoğuş-vakası** Halka grup-okumasının disiplinli yan-yana-okunma-zemini. Halka 4. dönem (Karşılaştırmalı Sentezler) v0.23 itibariyle henüz açılmadı; yöntemsel-akrabalık-aday-zincir-figürleri (Sarton bilim-tarihçilik akademik-disiplininin Amerikan-kurucu-formülasyonu Koyré ile Whig-tarihçiliği reddinde yöntemsel-akrabalık taşır; Gavroglu eleştirel-eklemlenme tezi Koyré'nin Hessen-Marksist-tezini 'akademik-yetersiz' bulmasının doğrudan akademik-zıttıdır; Ronan panoramik-bilim-kültür-anlatısı Koyré'nin teknik-içerikli içselci-yaklaşımına genel-okur perspektifi sunar; Patricia Fara *Bilim: Dört Bin Yıllık Tarih* uzun-vade-akademik-tarih-disiplinin akademik-yan-vakası) Halka müfredat-genişlemesinin disiplinli yan-zemininde değerlendirilir. Bu akademik-yapı içinde Koyré ek-kategoriden bilim-tarihçiliğin akademik-zemin-figürü olarak Halka 3. dönem-tarihçi-zincirinin her bir kitabıyla yan-cross-ref alır.
...
İlk oturumda **dikkat edilecek nokta** Koyré'nin meta-tarihyazımı disiplinidir: çağcıl-kategori göreli-tarihseldir, dönem-bölümlemeleri ders kitabı kurguları olabilir. Halka grup-okumasında bu disiplinin Halka'nın kendi dönem-yapısına uygulanması verimli olur: Halka'nın dönem-bölümlemesi (1. Dönem Çerçeve, 2. Dönem Doğu & İslam, 3. Dönem Bilim Devrimi, 4. Dönem Karşılaştırmalı Sentezler — v0.23 itibariyle henüz açılmamış) Koyré'nin uyarısına rağmen pedagojik-kullanışlılık nedeniyle korunur — ama bölümlemenin akademik-keskin-kategori değil, çalışma-organizasyonu olduğu görünür-tutulur. Halka müfredatı akademik-disiplinli yapısal-büyüme-vakasındadır (Halka 3. dönem #12-#18 yedi-kitap-zincir-konumlamasında, Halka 4. dönem açılış-aday-zincir değerlendirmesinde). Nicolaus Cusanus, Petrarca, Macchiavelli, Cesalpino gibi Yenidendoğuş-öncesi-figürlerin Cilt 1'in #1 makalesindeki konumlandırması Halka'nın Kuhn (#17) okumasından önce **paradigma-değişimi-kavramının ön-zemini** olarak yararlıdır.
