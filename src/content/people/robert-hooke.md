---
name: "Robert Hooke"
name_full: "Robert Hooke (Royal Society Curator of Experiments; Gresham College Geometry Professor)"
name_aliases: ["Hooke", "Robert Hook"]
dates: "1635-1703"
birth_year: 1635
death_year: 1703
...
works:
  - title: "Micrographia: or some physiological descriptions of minute bodies made by magnifying glasses"
    type: "mikroskop-biyoloji-fizik"
    year: 1665
    note: "Mikroskobik-gözlemlerin akademik-monografisi; 'cell' (hücre) terimini bilim-tarihine kazandırdı (mantar-tıkacının mikroskopik-yapısı için); aynı eserde optik-renk teorisi (ışığın titreşim-doğası, ince-tabaka renkleri) — Newton'un 1672 prizma-makalesinin akademik-rakip-zemini. Royal Society etiketiyle Londra'da basıldı, etkili-yayın oldu."
  - title: "An Attempt to Prove the Motion of the Earth from Observations"
    type: "astronomi"
    year: 1674
    note: "Cutler-Lectures dizisinin parçası; Hooke'un gravitasyon-tezinin ilk-yayını. Gezegen-hareketlerinin 'düz-doğrusal-eylemsizlik artı merkezcil-çekim' olarak tanımlanabileceği önerisi. 1679 Newton-yazışmasının akademik-arka planı."
  - title: "Lectures de Potentia Restitutiva, or of Spring"
    type: "fizik-mekanik"
    year: 1678
    note: "Esnek-yay deneyleri; 'ut tensio sic vis' (uzama-ile-kuvvet doğru-orantılı) Latince formülü. Modern fizik müfredatında 'Hooke yasası' adıyla kanonikleşti."
