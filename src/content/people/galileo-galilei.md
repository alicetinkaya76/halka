...
name_full: "Galileo di Vincenzo Bonaiuti de' Galilei"
name_aliases: ["Galileo", "Galileo Galilei"]
dates: "1564-1642"
birth_year: 1564
death_year: 1642
...
works:
  - title: "Sidereus Nuncius"
    ...
    year: 1610
    note: "İlk teleskopik gözlemler — Ay yüzeyinin pürüzlülüğü, Jüpiter'in dört uydusu (Galileo'nun 'Medici yıldızları' adlandırması Medici-himayesinin başlangıcı), Samanyolu'nun yıldız-doğası. Aristotelesçi göksel-yetkinlik kavramına ilk teleskopik darbe."
  - title: "Il Saggiatore (Tartıcı)"
    type: "felsefe-yöntem"
    year: 1623
    note: "'Doğanın kitabı matematik dilinde yazılmıştır; harfleri üçgenler, daireler ve diğer geometrik şekillerdir' formülü. Koyré'nin 'doğanın matematikselleştirilmesi' tezinin Galileo'nun kendi sözüyle ifadesi."
  - title: "Diyalog (İki Büyük Dünya Sistemleri Hakkında)"
    type: "astronomi-fizik"
    year: 1632
    note: "Salviati (Kopernikçi) – Sagredo (aydın okuyucu) – Simplicio (Aristotelesçi) üçlü-konuşma yapısında Kopernik sisteminin savunusu. Engizisyon davasının doğrudan tetikleyicisi (1633). Türkçe çeviri: Reşit Aşçıoğlu, Türkiye İş Bankası Kültür Yayınları, 2008."
  - title: "Discorsi (İki Yeni Bilim Üzerine Konuşmalar)"
    type: "fizik-mekanik"
    year: 1638
    note: "Engizisyon yasağı yüzünden İtalya'da değil Hollanda'da (Leiden, Elzevir) yayımlandı. Sabit ivmeli hareket, eğik-atış parabolü, malzeme dayanımı — modern mekanik-fiziğin temel-aksiyomatik metni. Koyré'ye göre Galileo'nun matematiksel-Platonik bilim-projesinin zirvesi."
