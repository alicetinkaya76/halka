...
name_full: "Pierre Gassend (Latinleştirilmiş: Petrus Gassendi)"
name_aliases: ["Gassend", "Petrus Gassendi"]
dates: "1592-1655"
birth_year: 1592
death_year: 1655
...
works:
  - title: "Exercitationes Paradoxicae adversus Aristoteleos"
    ...
    year: 1624
    note: "Aristotelesçi-skolastik felsefeye karşı sistematik eleştiri. Sadece I. ve VII. kitaplar yayımlanabildi (sansür); Gassendi'nin akademik-konumlandırma metni."
  - title: "De motu impresso a motore translato"
    type: "fizik"
    year: 1642
    note: "Galileo'nun düşen-cisimler kuramının deneysel-doğrulaması. Atalet kavramının Newton-öncesi formülasyonu."
  - title: "Animadversiones in decimum librum Diogenis Laertii"
    type: "felsefe-tarih"
    year: 1649
    note: "Diogenes Laertius'un Epikuros-yaşam-bölümünün şerhi. Atomistik felsefenin Hıristiyan-uyumlu yeniden-formülasyonunun temel metni."
  - title: "Syntagma Philosophicum"
    type: "felsefe-sistem"
    year: 1658
    note: "Ölümünden 3 yıl sonra Lyon'da yayımlanan, Gassendi'nin 6-kitaplık felsefe sistemi. Mantık-Fizik-Etik üç-bölümlü yapı. Atomistik fiziğin tam formülasyonu."
...
- **Gleick-Newton #12 (Halka 3. dönem-açılışı, v0.16 turu, AKTİF):** Gassendi'nin atomistik-felsefe canlanışı Newton'un *Principia*'sındaki mekanik-madde anlayışının doğrudan-felsefi-öncülüdür; Gleick'in Newton biyografisinde (Bölüm 2 "Some Philosophical Questions" Newton'un Cambridge'deki erken-okumalarında ve Bölüm 8 "In the Midst of a Whirlwind" Newton-Boyle akademik-tanışması bağlamında) Gassendi-Mersenne-Boyle atomistik-mekanik-felsefe ön-zinciri Newton'un corpuscular-felsefe konumunun yapısal-arka-planı olarak işlenir. Halka çerçevesinde Gassendi → Boyle → Newton atomistik-felsefe-zinciri Halka 3. dönem'in **somut 2-kitap düğümü** olarak kanonikleşir; `deneysel-felsefe` kavram-atomiği bu zincirin somut-akademik-bağıdır.
- **Westfall #15 (Modern Bilimin Oluşumu):** Westfall'ın Bilim Devrimi anlatısında Newton-öncesi mekanik-felsefe çerçevesinde Gassendi-Boyle-Hooke ekseni merkezi yer tutar. Gassendi atomiği Westfall turunda 2-kitap düğüm olur.
