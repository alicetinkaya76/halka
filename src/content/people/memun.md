...
works:
  ...
  - title: "Tahirîler hanedanını Horasan'da kurma"
    ...
    year: 821
    note: "Tahir ibnü'l-Hüseyn'i Horasan'a vali atayarak 50 yıl sürecek (821-873) yarı-bağımsız hanedanın temelini atması"

influenced_by:
  - "Hârun er-Reşid (baba)"
  - "Bermekîler vezir-hanedanı (Yahya, Cafer, el-Fadl — kültürel formasyon)"
  - "el-Fazl ibn Sehl (Merv dönemi vezir-akıl hocası)"
  - "Sasani siyaset literatürü (Ahd-i Ardeşir)"
  - "Mu'tezile kelamcıları (Bişr el-Merrisi, Sumâme ibn Eşres, Ahmed ibn Ebi Duâd)"

influenced:
  - "Mu'tasım (kardeşi-halefi, mihne'yi sürdürdü, 838 Amorium-Ankara seferi)"
  - "el-Vasık (yeğeni-halefi, mihne'yi 847'ye kadar sürdürdü)"
  - "Tahir ibnü'l-Hüseyn (Tahirîler hanedanı kurucusu)"
  - "Hunayn ibn İshak (akademik atölye patronu)"
