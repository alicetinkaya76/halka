...
works:
  - title: "Nova Methodus pro Maximis et Minimis"
    type: "matematik"
    year: 1684
    note: "Acta Eruditorum (Leipzig) Ekim 1684 sayısında 6-sayfalık makale; differansiyel-analizin akademik-yayın-tarihindeki ilk-kanonik-formülasyonu. dx, dy notasyonu, differantial-kuralları, maksimum-minimum bulma yöntemi. Newton'un fluxion-yöntemi henüz yayımlanmamıştı."
  - title: "De Geometria Recondita"
    type: "matematik"
    year: 1686
    note: "Acta Eruditorum'da integral-hesabının yayını; integral işareti ∫ (Latin 'summa' kelimesinin S-harfi uzatılmış formu) bu makalede tanıtılır."
  - title: "Théodicée"
    type: "felsefe-teoloji"
    year: 1710
    note: "Olası-dünyaların-en-iyisi tezi; Pierre Bayle ile felsefi-tartışma. Voltaire'in *Candide* (1759) eseri Leibniz'in iyimserliğinin satirik-eleştirisi."
  - title: "Monadologie"
    type: "metafizik"
    year: 1714
    note: "Monad'ların atomik-zihinsel-tözler olduğu metafizik-tezi; Leibniz-felsefesinin sistematik-formülasyonu."
  - title: "Commercium Philosophicum et Mathematicum (Leibniz-Newton yazışmaları, ölümünden sonra)"
    type: "akademik-yazışma"
    year: 1745
    note: "Leibniz-Bernoulli akademik-yazışmasının yayını; öncelik-tartışmasının akademik-arşivlik-malzemesi."
