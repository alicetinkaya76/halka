...
> **Versiyon:** v0.10.1 — **Atomik dalga: Pedersen #7 + Sezgin #8 atomik atlası.** 20 atomik dosya inşa edildi (4 yer + 11 kişi + 5 kavram = 18 yeni + 2 zenginleştirme). Atomik altyapı turu (içerik milestone'u DEĞİL); müfredat sayımı **8/21 = 38% korunur**. Yoğun-stub stratejisi (200-400 kelime gövde, ortalama 406 çıktı), aktif yorumlu cross-ref blokları, slug-eşleşmeli cross-ref disiplini. Atomik graf düğümlerinde stratejik zirveler: **Bağdat 6 kitap** (Halka atomik atlasının zirve düğümü, "kümülatif bilgi ağı" tezinin görsel kanıtı), **Tercüme Hareketi 5 kitap** (atomik graf'ın ikinci en zengin düğümü), **Bîrûnî 4 kitap** (Sezgin metodolojik motto kaynağı + dört-kitap-kesişimli ilk atomik). Westfall #15 ile `celisir` deklarasyonunun (4. çelişir) atomik kanıt katmanı 5 figürle inşa edildi (Tûsî + Şâtır + Urdî + Tûsî-couple + Kopernik-Şâtır-Ay-modeli) — 3. dönem girişinde teknik kontra-anlatı omurgası hazır. Hobson #4 ile `uyumlu` cross-ref'in atomik kanıt zinciri 2 figürle (Cezerî + Takiyüddin) inşa edildi. **Sıfır şema değişikliği** — Hobson'dan beri **8 kitap + 1 atomik dalga için "v1.0 kanıtlanmış"** iddiası 9. ampirik testi geçti; YAML frontmatter validasyonu 20/20, slug konvansiyonu 20/20, wikidata_id null tuzağı 20/20'de kaçınıldı. Cross-ref omurgası: Pedersen omurga 4 kişi + 2 kavram (İbn Nedim, İbn Mukla, Yâkût, Câhız + warrâkun, hat-ekolleri); Sezgin omurga 7 kişi + 3 kavram (Tûsî, Şâtır, Urdî, İbnü'l-Heysem, Cezerî, Takiyüddin, Bîrûnî + Tûsî-couple, Kopernik-Şâtır-Ay-modeli); 4 ortak yer çift-yön cross-ref (Bağdat, Maraga, Şam, Semerkant). v0.10 — **2. dönem teknik-bilim içerik halkası.** Fuat Sezgin #8 *İslam'da Bilim ve Teknik* Cilt I (Wissenschaft und Technik im Islam 2003; TÜBA 2007 + İBB Kültür A.Ş. 2008, çev. Abdurrahman Aliy) book.md eklendi (8/21 = 38% müfredat, 2. dönem 4/7). Frontmatter şablon zirvesinde: 23 kişi, 10 yer, 13 kavram, 7 thematic chapter, 12 müfredat-içi ilişki, 10 tartışma sorusu, 6 eleştirel okuma notu, 15 atomik iddia, 21 tag, ~3417 kelime gövde (9 bölüm). **Sıfır şema değişikliği** — Hobson'dan beri **8 kitap için "v1.0 kanıtlanmış"** iddiası ampirik olarak doğrulandı. Tarihyazımı: anti-Eurocentric (kamp 7/8 = 88%) + **multipolar** (Halka'nın multipolar olarak işaretlenen ilk kitabı; çoğul-merkez Bağdat-Endülüs-Mâveraünnehir-Maraga-Şam-İstanbul) + internalist + **non-declensionist (nüanslı)** — Halka declensionism dengesi 5-2 → **6-2 non-declensionist** çoğunluğa pekişti, Starr ile `kismen_celisir` deklarasyonu (claim-005 → starr::claim-007). Cross-ref omurgası: Pedersen=`dogrudan_kaynak` (v0.9 forward-bağ tamamlandı), Freely=`uyumlu` (Tusi-Şâtır-Kopernik teknik-kanıt ittifakı), Hobson=`uyumlu` (Cezerî-Takiyüddin teknoloji transferi), Westfall=`celisir` (3. dönem ileri — Halka'nın 4. `celisir` deklarasyonu). Sürpriz vurgular tam yedirildi (Tusi-Urdi-Şâtır-Kopernik 5 noktalı teknik özdeşlik, Bizans-Trabzon-İstanbul-Krakau geçiş hattı orijinal argümanı, Cezerî 1206 → Takiyüddin 1546 6-pistonlu pompa silsilesi, 12 maddelik yaratıcılık sebepleri listesi, Frankfurt 1982 + İstanbul 2008 maddi rekonstrüksiyon programı, Mustafa el-Muvakkit Tobolsk koordinatı, Türk akademik silsilesi Sayılı paraleli). Toplam müfredat-içi ilişki 42 → 54; toplam atomik tartışma sorusu 70 → 80. v0.9 — Pedersen #7 *İslam Dünyasında Kitabın Tarihi* (2. dönem KANONİK AÇILIŞ): 20 kişi/10 yer/12 kavram/15 iddia/10 ilişki, declensionism 4-2 → 5-2 non-declensionist. Frontmatter şablon zirvesinde: 20 kişi, 10 yer, 12 kavram, 7 thematic chapter, 10 müfredat-içi ilişki (1. dönem geri-bağ 6 + 2. dönem ileri-cross-ref 4), 10 tartışma sorusu, 6 eleştirel okuma notu, 15 atomik iddia, 19 tag, ~2284 kelime gövde. Sıfır şema değişikliği — **Hobson'dan beri 7 kitap, "v1.0 kanıtlanmış" iddiası ampirik olarak doğrulandı.** Tarihyazımı: anti-Eurocentric + Baghdad-centric (Freely'den sonra ikinci) + mixed + **non-declensionist** — Halka declensionism dengesi 4-2 → **5-2 non-declensionist** çoğunluğa kaydı, Starr ile `kismen_celisir` deklarasyonu yapıldı. Cross-ref omurgası: Freely=`dogrudan_kaynak` (2. dönem geçişinin teknik omurgası), Sezgin/Lyons/Gutas/Berkey=ileri-cross-ref'ler hazır. Sürpriz vurgular tam yedirildi (793 Bağdat kâğıt revolution'ı, warraqun sınıfı, Suk al-Warraqin, hat ekolleri Kufî→Maghribî→Nesih→Sülüs→Dîvânî, cilt geleneği, Beytü'l-Hikme'nin mimari tarafı + bonus Fihrist geleneği'nin 1000 yıllık devamlılığı). Slug disambiguation diliği (Johannes Pedersen #7 açık-yazılı) 8 cross-ref note'unda korundu. Toplam müfredat-içi ilişki 32 → 42; toplam atomik tartışma sorusu 60 → 70. v0.8.4 — F1.1 Pagefind static search canlıda (Faz 2 TAM kapanış: 8530 kelime, 14 sayfa indeksli, ~1.1MB index, ⌘K kısayolu, Türkçe WASM, Halka design system uyumlu). v0.8.3 — F1.3 tarihyazımı 2D scatter + F1.4 kapak yer tutucusu. v0.8.2 — Faz 2 Kol A (feedback hızlı uyum): F1.6/F1.7/F1.8/F2.5, şema 4 alan (`reading_level`+`accessibility_note`+`cover_image`+`cover_credit`), hibrit lisans (MIT+CC BY-SA 4.0), Pedersen disambiguation §12.2. v0.8.1 — Faz 0 KAPANDI: alicetinkaya76.github.io/halka canlıda. v0.8 — 1. dönem 6/6 = TAM (60 atomik tartışma sorusu).
> **Son güncelleme:** 3 Mayıs 2026 (v0.10.1 atomik dalga)
...
| v0.8.4 | 1 Mayıs 2026 | **F1.1 — Pagefind static search canlıda.** Faz 2 Kol B'nin son kalan polish maddesi: arama. WhatsApp Yorumcu 1'in 8 önerisinin sonuncusu kapatıldı; Faz 2'nin tüm Kol A + Kol B kapsamı sıfırlandı. **Teknik:** Pagefind 1.x npm paketi devDependency olarak eklendi, package.json `build` scripti `astro build && pagefind --site dist` zincirine geçti. GitHub Actions workflow değişikliği gerekmedi — `npm ci && npm run build` zaten doğru zinciri çalıştırıyor. Pagefind build sonrası `dist/pagefind/` klasörünü oluşturur (1.1MB toplam: tr.pagefind WASM, index parçaları, fragment dosyaları, UI CSS+JS). Index istatistikleri: **8530 kelime, 14 sayfa, Türkçe dil desteği**. **UI:** BaseLayout header'ına "Ara" butonu eklendi (büyüteç ikonu + sm:"Ara" label + md:`⌘K` kbd). Buton tıklanınca veya `Cmd+K` (Mac) / `Ctrl+K` (Windows/Linux) ile modal açılır; backdrop blur + center pt-20 px-4; max-w-2xl beyaz kart, rounded-sm; "Halka'da ara" başlığı + Esc'le kapatma + dış tıklama ile kapatma + dinamik focus. Pagefind UI dynamically import edilir (sadece modal açılınca yüklenir, ilk sayfa yüküne sıfır maliyet). Dev modda graceful fallback: pagefind/ klasörü yok diye search açılmaz, kibar mesaj gösterir ("indeks sadece npm run build sonrası üretiliyor"). **Halka design system entegrasyonu:** Pagefind UI CSS variables override edildi (`--pagefind-ui-primary` → `--halka-emerald`, `--pagefind-ui-text` → `--halka-ink`, `--pagefind-ui-tag` → emerald-tinted, font-family Inter). Sonuç highlight'ları emerald-tinted (rgba 14, 107, 94, 0.15). Sonuç başlıkları ink koyu, hover'da emerald. **Türkçe çeviriler:** Pagefind UI placeholder, zero-results, many-results, search-suggestion mesajları Türkçe ("Ara: kitap, kişi, yer, kavram…", "X sonuç: aranan_terim", "Sonuç bulunamadı: aranan_terim"). **Aksesibilite:** Modal `role="dialog" aria-modal="true"`; trigger `aria-label`; close button `aria-label`; klavye kısayolları (⌘K aç/kapat, Esc kapat); focus trap input'ta. **Erişilebilir alanlar:** Tüm `kitaplar/`, `kisiler/`, `yerler/`, `kavramlar/` sayfaları + ana index — atomik dosyalar dahil. Yorumcu 1'in "arama yapılan terimle ilgili ilişiği olanların hepsi sıralanır altında küçük dipnotlar olur içeriğe bakıp detayına tıklayıca içeriğe gidilir" tarifi birebir karşılandı (Pagefind Default UI snippet preview + click-to-page paterni). **Build temiz: 14 sayfa Astro + 1.1MB Pagefind index, toplam ~12 saniye (npm install dahil değil).** Değişen dosyalar: `package.json` (build script + pagefind devDependency), `package-lock.json` (otomatik), `src/layouts/BaseLayout.astro` (search button + modal + script + CSS override). v0.9 = Pedersen / 2. dönem açılış için saklı; v0.8.4 ile Faz 2 polish'i tam — sonraki tur içerik milestone. |
| v0.9 | 3 Mayıs 2026 | **2. dönem KANONİK AÇILIŞ — Johannes Pedersen #7 *İslam Dünyasında Kitabın Tarihi* (Den Arabiske Bog 1946; İng. The Arabic Book, Princeton UP 1984, çev. Geoffrey French) book.md eklendi.** Faz 2 polish'i v0.8.4'te tamamlanmıştı; bu sürüm "şablon v1.0 kanıtlanmış" iddiasının 7. kitap üzerinde ampirik testidir — **hiçbir yeni şema alanı eklenmedi** (Hobson'dan beri 7 kitap: yalnızca v0.8.2'de UX-feedback için 4 alan eklendi, hepsi opsiyonel veya gerekçeli zorunlu). Karar zinciri (handoff K1 (c) + K2 + K3) sabitlendiği gibi: iki Pedersen disambiguation diliği frontmatter ve cross-ref note metinlerinde korundu (8 cross-ref note'unda "Halka'da Johannes Pedersen #7" açık-yazılı), 2. dönem açılış kitabı olarak Johannes Pedersen seçildi (Sezgin değil), book.md önce + atomik dosyalar toplu sonra paterni sürdürüldü. **Frontmatter genişliği şablon zirvesinde:** **20 kişi, 10 yer, 12 kavram, 7 thematic chapter (özetli), 10 müfredat-içi ilişki, 10 tartışma sorusu, 6 eleştirel okuma notu, 15 atomik iddia (claim-NNN format), 19 tag, ~2284 kelime gövde** (Starr modeli 1165 kelime'in 2x'i; 8 bölüm: Yazarın motivasyonu / Üç ana eksen / Kitabın açılış sahnesi: 793 Bağdat kâğıt devrimi / Anahtar mecaz: Warraqun ekonomisi / Methodolojik tartışmalar / Halka için stratejik okuma (canonical heading) / Eleştirel okuma için uyarılar / Halka müfredatındaki yeri). **Tarihyazımı pozisyonu:** anti-Eurocentric (kamp 6/7 = 86%) + Baghdad-centric (Freely'den sonra ikinci Bağdat-merkezli kitap) + mixed (içselci-dışsalcı) + **non-declensionist** — Halka declensionism dengesi 4-2'den **5-2 non-declensionist** çoğunluğa kaydı; Starr'ın "üç imparatorluk şerhçilik tezi" ile (1500 sonrası çöküş) doğrudan `kismen_celisir` deklarasyonu yapıldı, gerilim hat-Mukla-Yâkût-Suyûtî-Sehâvî kanıt zinciri üzerinden test edilebilir hale geldi. **Cross-ref omurgası:** 1. dönem geri-bağları 6 deklarasyon (Freely=`dogrudan_kaynak` 2. dönem geçişinin teknik omurgası, Hobson/Goody-R/Fara=`uyumlu`, Goody-BD=`tematik_tamamlayici`, Starr=`kismen_celisir`) + 2. dönem ileri-cross-ref'leri 4 deklarasyon (Sezgin=`dogrudan_kaynak`, Lyons/Gutas=`uyumlu`, Berkey=`kurumsal_tamamlayici`); claim-level çapraz bağlar Freely::tez-bagdat-merkezli + Hobson::claim-001 + Goody-R::claim-004 + Goody-BD::tez-kapitalizm-onculleri + Starr::claim-002,004,007. **Toplam müfredat-içi ilişki: 32 → 42 deklarasyon.** **Sürpriz vurgular tam yedirildi:** 793 Bağdat kâğıt revolution'ı (claim-002, key_concepts.kagit-devrimi-793, key_places.talas, gövde "Kitabın açılış sahnesi" bölümü), warraqun sınıfı (claim-003, claim-013, key_concepts.warraqun, gövde "Anahtar mecaz" bölümü), Suk al-Warraqin (yer + kavram olarak iki cepheden), hat ekolleri (Kufî→Maghribî→Nesih→Sülüs→Dîvânî, claim-004, key_concepts.hat-ekolleri + key_concepts.hat-mensub, key_people üç hattat dahil: İbn Mukla + İbn el-Bevvâb + Yâkût el-Müsta'simî), cilt geleneği (claim-005, 200 yıl Avrupa öncesi), Beytü'l-Hikme'nin mimari tarafı (key_places.beytulhikme + key_concepts.beytulhikme-mimari, claim-006: raf + rutubet + ödünç verme protokolü). **Bonus pedagojik bulgu:** Fihrist geleneği'nin 1000 yıllık devamlılığı — İbn en-Nedim (987) → Hacı Halîfe (17. yy) → Bağdatlı İsmail Paşa (19. yy) zinciri, key_concepts.fihrist-gelenegi + claim-012 + key_people üç bibliyografyacı dahil — tabakat.io / GAS / OpenITI ile metodolojik köprü kuruldu. **Türkçe çeviri metadata kasten boş bırakıldı** (turkish_publisher, turkish_translator, turkish_year, isbn, pages, chapters_count) — handoff "Klasik Yayınları kontrol edilmeli" dedi, doğrulanmamış değer üretmek atomik veri disiplini ile çelişir; Faz 2 Kol B kapak toplama turuyla beraber bu alanlar netleştirilebilir, ZOD şemasında zaten hepsi optional. **ZOD doğrulama temiz:** 23 top-level key, tüm relation enum'ları (10/10), tüm claim type enum'ları (15/15), tüm historiographical_position enum'ları, tüm claim-NNN regex'i (15/15), canonical heading mevcut (`## Halka için stratejik okuma` v0.8.2 F1.6 standardı). **`curriculum.ts` değişikliği gerekmedi** — Pedersen entry'si zaten v0.5'ten beri orada (`status: 'sirada', sira_no: 7`), book.md eklenince otomatik bağlanır. **Build doğrulaması (repo'da çalıştırılacak):** beklenen 15 sayfa (önceki 14 + yeni Pedersen), Pagefind index ~9000+ kelime'ye genişler, ~3-5s, sıfır error. **Müfredat genel durumu:** 6/21 → **7/21 = 33%**; 2. dönem 2/7 → **3/7 = 43%** (Freely=okundu, Starr=okunuyor, Pedersen=sirada); 1. dönem zaten 4/4 = 100%. Sıradaki içerik milestone: v0.10 = Sezgin #8 (GAS Cilt 1 — Pedersen'in metodolojik mirasçısı, `dogrudan_kaynak` ön-bağı zaten kuruldu) **veya** v0.9.1 = Pedersen atomik dosyaları (people/places/concepts stub'ları, K3 deklarasyonuna göre toplu sonra). **Süreç dersi:** v0.8 1. dönem TAM kapanışı + v0.8.1-v0.8.4 polish + v0.9 = yeni içerik patternine ilk dönüş — şablon disiplini test edildi ve geçti, "v1.0 kanıtlanmış" iddiası 7. kitap üzerinde ampirik olarak doğrulandı. |
| v0.10 | 3 Mayıs 2026 | **2. dönem teknik-bilim içerik halkası — Fuat Sezgin #8 *İslam'da Bilim ve Teknik* Cilt I (*Wissenschaft und Technik im Islam* 2003 Almanca özgün; 1. basım TÜBA + Kültür ve Turizm Bakanlığı, Ankara 2007; 2. basım İBB Kültür A.Ş., İstanbul Nisan 2008, çev. Abdurrahman Aliy + Eckhard Neubauer'in katkılarıyla) book.md eklendi.** Pedersen v0.9 ile kurulan 2. dönem açılışının teknik-bilim içerik halkası: Pedersen "kitap nasıl üretildi" sorusunu yanıtlar (warraqun + hat + cilt + kütüphane), Sezgin "kitapların içinde ne yazıyordu" sorusunu yanıtlar (matematik + astronomi + tıp + optik + mekanik) — iki köşe yan yana 2. dönem'in epistemolojik haritasını tamamlar. **Hiçbir yeni şema alanı eklenmedi** — Hobson'dan beri **8 kitap için "v1.0 kanıtlanmış"** iddiası 8. kitap üzerinde ampirik olarak doğrulandı; sıfır şema değişikliği disiplini sürdürüldü. Karar zinciri: K1 (cilt seçimi) PDF TOC'una göre tashih edildi — handoff "tematik seçme" önermişti, ama yüklenen Türkçe Cilt I aslında "Arap-İslam Bilimleri Tarihine Giriş" (tüm külliyatın metodolojik girişi) olduğu için **Cilt I baz + Cilt II-V tematik atıf-aksı** kararı verildi; K2 sıralama (Pedersen #7 → Sezgin #8 → Lyons #9) korundu; K3 atomik dalga (people/places/concepts toplu olarak v0.11+'a) ertelendi. **Yayıncı tashihi:** Handoff'ta "Boğaziçi Yayınları, 5 cilt, 2007" olarak yanlış kaydedilmişti — atomik veri disiplini gereği düzeltildi. Doğru: 1. basım TÜBA + Kültür ve Turizm Bakanlığı (Ankara, 2007); 2. basım İBB Kültür A.Ş. (İstanbul, Nisan 2008, Gülhane Müzesi açılışına eşzamanlı). Çevirmen: Abdurrahman Aliy (Eckhard Neubauer'in Almanca metne katkılarıyla); editör: Hayri Kaplan + Aliy. ISBN 978-975-17-3253-8. Frontmatter doğrulandı, `critical_reading_notes` ilk maddesinde tashih notu açıkça yazıldı (Boğaziçi Yayınları'nın Sezgin'in başka bir popüler eseriyle karıştırılmış olma ihtimali Halka grup-okuma öncesi teyit edilmek üzere not düşüldü). **Frontmatter genişliği şablon zirvesinde:** **23 kişi, 10 yer, 13 kavram, 7 thematic chapter (özetli), 12 müfredat-içi ilişki, 10 tartışma sorusu, 6 eleştirel okuma notu, 15 atomik iddia (claim-NNN format), 21 tag, ~3417 kelime gövde** (Pedersen v0.9'un 2284 kelime'sinden ~%50 büyük; Starr v0.2 modeli 1165 kelime'in 3x'i; **9 bölüm**: Yazarın motivasyonu / Üç ana eksen / Cildin yapısı: Cilt I'in metodolojik açılış işlevi / Anahtar vaka: Tusi-Urdi-Şâtır-Kopernik teknik özdeşlik / Anahtar vaka: Cezerî mekaniklerinden Takiyüddin İstanbul rasathanesine — yaratıcılık 16. yy ortasına kadar / Sezgin'in declensionism konumu — nüanslandırma / Halka için stratejik okuma (canonical heading) / Eleştirel okuma için uyarılar / Halka müfredatındaki yeri). **Tarihyazımı pozisyonu:** anti-Eurocentric (Halka kampı 7/8 = **%88**) + **multipolar** (Halka'nın multipolar olarak işaretlenen **ilk kitabı**; Freely+Pedersen Bağdat-merkezci, Starr Mâveraünnehir-merkezci/anti-Bağdat, Sezgin "ikisi de + Endülüs + Şam + Mısır + Maraga + Tebriz + İstanbul" diyen çoğul-merkez **üçüncü kategoridir**; tarihyazımı 2D scatter X ekseninde merkez bant) + internalist (teknik-içerik dökümü ağırlıklı) + **non-declensionist (nüanslı)** — Halka declensionism dengesi 5-2'den **6-2 non-declensionist** çoğunluğa pekişti. Sezgin'in nüansı dört maddeli: (a) klasik dini-teolojik çöküş tezini reddeder, (b) 1100/Gazzâlî sonrası çöküş tezini reddeder, (c) **16. yy ortasında gevşeme + 16. → 17. yy duraklamayı kabul eder** (Cilt I Bölüm III), (d) sebebi küresel-tarihsel bağlama (Yeni Dünya keşfi, Atlantik ekonomisi, Osmanlı askerî yönelişi) bağlar; basit "İslam asla durmadı" pozisyonu **değildir**. Starr'ın "üç imparatorluk şerhçilik tezi" ile (1500 sonrası teolojik çöküş) doğrudan `kismen_celisir` deklarasyonu yapıldı (claim-005 → starr::claim-007 conflicts_with). **Cross-ref omurgası: 12 deklarasyon** (Pedersen v0.9'da kurulan ileri-bağ tamamlandı + 11 yeni cross-ref): Pedersen=`dogrudan_kaynak` (v0.9'da Sezgin tarafına ileri deklare edilmişti, v0.10'da Sezgin tarafından geri-bağ teyidi tamamlandı — 2. dönem geçişinin teknik omurgasının çift-yön kaydı), Freely=`uyumlu` (Tusi-Urdi-Şâtır-Kopernik teknik-kanıt ittifakı: Freely fikir-katmanı + Sezgin teknik-kanıt = Halka anti-Eurocentric kampının en derin teknik silahı), Starr=`kismen_celisir`, Hobson=`uyumlu` (Cezerî-Takiyüddin → Avrupa Agricola/Ramelli teknoloji transferi mikro-tarihsel kanıt), Goody-R=`uyumlu` (çoklu rönesans çerçevesinin teknik-içerik doldurması), Goody-BD=`tematik_tamamlayici` (12 maddelik liste 6. madde "bilim adamlarının meslek-mensupluğu" = Goody-BD entelektüel emek piyasası tezinin atomik kanıtı), Fara=`olcek_karsitligi` (panoramik-generalist vs teknik-derinlikli ölçek karşıtlığı), Lyons=`kismen_celisir` (3. dönem ileri — popüler-anlatı vs akademik-teknik ton karşıtlığı), Gutas=`uyumlu` (3. dönem ileri — Tercüme Hareketi politik-kültürel motivasyonlar tamamlayıcılığı), Berkey=`kurumsal_tamamlayici` (3. dönem ileri — sema-icaze sistemi eğitim-kurumsal aktarım tarafı), **Westfall=`celisir`** (3. dönem ileri — Sezgin'in 5 noktalı Tusi-Şâtır-Kopernik listesi içselci Bilim Devrimi anlatısının dördüncü cepheli teknik karşı-kanıtı; Halka'nın 4. `celisir` deklarasyonu, Goody-R + Freely + Fara'dan sonra), Needham=`uyumlu` (4. dönem ileri — GAS / Science and Civilisation in China dev-paralel ittifakı). Claim-level çapraz bağlar: Freely::claim-004 + Goody-R::claim-004 + Hobson::claim-005 (claim-002 supports), Hobson::claim-001 (claim-007 supports), Pedersen::claim-013 (claim-008 supports), Goody-BD::tez-kapitalizm-onculleri (claim-008 supports), Pedersen::claim-006 (claim-009 supports), Pedersen::claim-001 (claim-012 supports), Fara::claim-001 (claim-013 supports), Starr::claim-007 (claim-005 conflicts_with). **Toplam müfredat-içi ilişki: 42 → 54 deklarasyon.** **Sürpriz vurgular tam yedirildi:** Tusi-Urdi-Şâtır-Kopernik 5 noktalı teknik özdeşlik vakası birinci-elden Sezgin Cilt I'den çıkarıldı (claim-002, key_concepts.kopernik-satir-ay-modeli + tusi-couple + urdi-lemma, dedicated body section "Anahtar vaka: Tusi-Urdi-Şâtır-Kopernik teknik özdeşlik"), Bizans-Trabzon-İstanbul-Krakau geçiş hattı (Sezgin'in özgün coğrafi argümanı — claim-003, key_places.tebriz-trabzon-istanbul-hat, key_concepts.bizans-uzerinden-gecis; Sandivogius 1430 + Brudzevo 1482 Polonya astronomi şerhleri kanıtı, Kopernik Krakau eğitiminin 1491-1495 tarihsel-coğrafi koşulu), Cezerî 1206 → Takiyüddin 1546 6-pistonlu su pompası 350 yıllık silsile (claim-007, dedicated body section "Anahtar vaka: Cezerî mekaniklerinden Takiyüddin İstanbul rasathanesine"), Takiyüddin 1577 İstanbul Tophane rasathanesi Tycho Brahe Uraniborg 1576 ile birebir çağdaş + 1580 yıkımının dini değil politik kararla olması (claim-006), 12 maddelik yaratıcılık sebepleri pozitif listesi (claim-012, key_concepts.arapca-bilim-dili + meslek-mensupluğu + cami-temelli-universite), Frankfurt İslam Bilimleri Tarihi Enstitüsü 1982 + İstanbul İslam Bilim ve Teknoloji Tarihi Müzesi 2008 + Wiedemann mirası maddi rekonstrüksiyon programı (key_places.frankfurt-enstitusu + istanbul-bilim-muzesi, key_concepts.wiedemann-sezgin-rekonstruksiyon, claim-014), Mustafa el-Muvakkit 1525 İʿlâm el-İbâd'da Tobolsk koordinatı (claim-011, Mercator'un 16. yy Tobolsk verisinin İslam kaynağına işaret), Türk akademik silsilesi Sayılı paraleli (claim-010, key_people.sayili-aydin "Sarton'un Harvard 1942 ilk doktora öğrencisi" — Frankfurt-sürgün/Ankara-kalış iki rota karşılaştırma, critical_reading_notes 1960 sürgün maddesi). **Disambiguation diliği:** "Halka'da Fuat Sezgin #8" 12 yerde geçiyor (cross-ref note'larında pedagojik tutarlılık için). **Bilim Tarihi Türk akademisi köprüsü:** 4. dönem Unat #20 + İhsanoğlu #21 ile köprü ön-bağı (claim-010 + Sezginci ekol IRCICA tartışması Halka grup oturumunda işlenmek üzere); modern tabakat.io / GAS pipeline / OpenITI Enrichment projelerinin Sezgin metodolojisinden devraldığı miras (Wiedemann maddi rekonstrüksiyon → Sezgin GAS → Çetinkaya-Gökalp dijital prosopoğrafya hattı). **ZOD doğrulama temiz:** 23 top-level key, tüm relation enum'ları (12/12), tüm claim type enum'ları (15/15: ana_tez/tarihsel_duzeltme×4/metodolojik_tez×3/nedensellik_tezi/kurumsal_tez×2/tarihyazimi_tezi×2/kavramsal_tez), tüm historiographical_position enum'ları (multipolar enum'ı şemada zaten tanımlı), tüm claim-NNN regex'i (15/15), canonical heading mevcut (`## Halka için stratejik okuma` v0.8.2 F1.6 standardı). **`curriculum.ts` değişikliği gerekmedi** — Sezgin entry'si zaten v0.5'ten beri orada (`status: 'sirada', sira_no: 8, donem_no: 2`), book.md eklenince otomatik bağlanır. **Build doğrulaması (repo'da çalıştırılacak):** beklenen 16 sayfa (önceki 15 + yeni Sezgin), Pagefind index ~12000+ kelime'ye genişler (Sezgin tek başına ~3417 kelime + frontmatter 9000+ kelime gerçek metin), ~3-5s, sıfır error. **Müfredat genel durumu:** 7/21 → **8/21 = 38%**; 2. dönem 3/7 → **4/7 = 57%** (Freely=okundu, Starr=okunuyor, Pedersen=sırada, Sezgin=sırada); 1. dönem zaten 4/4 = 100%; 3. dönem 0/5; 4. dönem 0/5. Sıradaki içerik milestone: **v0.11 = Lyons #9** (Hikmet Evi: Beytü'l-Hikme popüler-anlatı, Sezgin'in akademik-teknik tonunun karşıt-tonal okuma deneyi) **veya** v0.10.1 = Pedersen+Sezgin atomik dosyaları (people/places/concepts stub'ları, K3 deklarasyonuna göre toplu sonra — atomik dalga ertelenmesi 2 kitap birikti). **Süreç dersi:** v0.9 = "v1.0 kanıtlanmış" iddiasının 7. kitap testi geçti; v0.10 = aynı disiplinin 8. kitap üzerinde **gövde-kelime şablon zirvesinde** (3417 kelime, 9 bölüm) ampirik tekrar-doğrulanması — şablon disiplini içerik karmaşıklığı arttıkça da ayakta kalıyor. v0.10'un 9 bölümlük gövdesinde iki "Anahtar vaka" alt-bölümünün eklenmesi şablon sözleşmesinin esneklik-toleransı için iyi bir test idi (canonical heading sırası bozulmadı, opsiyonel detay-bölümleri başlık olarak işlendi). |

| v0.10.1 | 3 Mayıs 2026 | **Atomik dalga: Pedersen #7 + Sezgin #8 atomik atlası — 20 atomik dosya inşa edildi.** İçerik milestone'u DEĞİL, atomik altyapı turu — müfredat sayımı **8/21 = 38% korunur**. K3 deklarasyonuna (atomik dalga ertelenmesi) göre v0.9 + v0.10 ile biriken iki kitabın stratejik atomikleri topluca inşa edildi: **4 yer** (bagdat, maraga, sam, semerkant — çift-yön cross-ref omurgası), **11 kişi** (7 Sezgin omurga: tusi + ibn-sh-shatir + urdi-muayyededdin + ibn-el-heysem + cezeri + takiyuddin-er-rasid + biruni-zenginleştirme; 4 Pedersen omurga: ibn-nedim + ibn-mukla + yakut-el-mustasimi + cahiz), **5 kavram** (4 yeni: warraqun + tusi-couple + kopernik-satir-ay-modeli + hat-ekolleri; 1 zenginleştirme: tercume-hareketi). Toplam: 18 yeni dosya + 2 zenginleştirme. Karar zinciri (Claude tarafından K1-K2-K3, Ali "sen seç" delegasyonuyla): K1 = (a) yoğun-stub 20 atomik; K2 = stub-strategy (200-400 kelime gövde, opsiyonel DH-ID alanları tamamen kaldırılır — `wikidata_id` null tuzağı 20/20'de kaçınıldı); K3 = (b) aktif yorumlu cross-ref bloğu (her cross-ref'in rolünü açıklayan 2-3 cümlelik blok). **Yoğun-stub metrikleri:** ortalama gövde kelime 406 (hedef 200-400 üst sınırına yakın; aktif yorumlu cross-ref pedagojik maliyet); en uzun gövde **bagdat** 511 kelime (6 kitap cross-ref) ve **tercume-hareketi** 531 kelime (5 kitap cross-ref); en kısa gövde **cahiz** 335 kelime. **Cross-ref omurgası — atomik graf zirveleri:** **bagdat = 6 kitap** (Fara + Goody-BD + Hobson + Freely + Pedersen + Sezgin) — Halka atomik atlasının zirve düğümü, "kümülatif bilgi ağı" tezinin görsel-pedagojik kanıtı; **tercume-hareketi = 5 kitap** (Pedersen + Sezgin + Freely + Starr + Hobson) — atomik graf'ın ikinci en zengin düğümü; **biruni = 4 kitap** (Fara + Freely + Starr + Sezgin) — Sezgin Cilt I metodolojik açılış mottosu kaynağı, dört-kitap-kesişimli ilk atomik. 3 kitaplı: maraga + semerkant. 2 kitaplı: sam (disipliner çift-yorum vakası: kitap-edebiyat + astronomi). 1 kitaplı (stratejik altyapı, ileri-cross-ref hazırlığı): 14 atomik. **Westfall #15 ile `celisir` deklarasyonunun atomik kanıt katmanı (4. çelişir):** 5 atomikle inşa edildi (tusi + ibn-sh-shatir + urdi-muayyededdin + tusi-couple + kopernik-satir-ay-modeli) — 3. dönem girişinde teknik kontra-anlatı omurgası tam-yapı olarak hazır; Halka okuyucusu Westfall okuduğunda bu 5 atomiğin cross-ref bağlantılarını tek-bakışta görecek. **Hobson #4 ile `uyumlu` cross-ref'in atomik kanıt zinciri:** 2 atomikle inşa edildi (cezeri + takiyuddin-er-rasid) — Cezerî 1206 → Takiyüddin 1546 → Avrupa Agricola 1556 / Ramelli 1588 teknoloji-transfer silsilesinin Avrupa-öncesi iki halkası. **Şablon disiplini doğrulaması:** YAML frontmatter parse 20/20 ✅, slug konvansiyonu (book.md ↔ atomik dosya birebir-eşleşme) 20/20 ✅, `slug:` field'ı frontmatter'da YOK 20/20 ✅ (Astro dosya adından üretir), `wikidata_id` regex `^Q\d+$` null tuzağı 20/20 kaçınıldı ✅, cross-ref bloğu (`## Halka müfredatında geçer`) 20/20 ✅. **Şema değişikliği: SIFIR.** Hobson'dan beri **8 kitap + 1 atomik dalga için "v1.0 kanıtlanmış"** iddiası 9. ampirik testi geçti — `src/content/config.ts` ZOD şemaları (people/places/concepts, satır 237-325) değişmedi; 20 atomik dosya yeni şema sözleşmelerinin tümüne uygun. **Build doğrulaması (Ali tarafında çalıştırılacak):** beklenen **36 sayfa** (önceki 16 + yeni 20 atomik), Pagefind index ~14000+ kelime'ye genişler (8132 yeni atomik gövde-kelimesi + mevcut), ~5-7s, sıfır error. **Müfredat genel durumu:** **8/21 = 38% korunur**; 2. dönem 4/7 = 57% korunur; atomik atlas dağılımı **+20 kalem** zenginleşir. Toplam atomik graf 4-kitap-cross-ref-üstü düğüm: 0 → **3** (bagdat 6, tercume-hareketi 5, biruni 4). Sıradaki içerik milestone: **v0.11 = Lyons #9** *Hikmet Evi* (popüler-anlatı, Sezgin'in akademik-teknik tonunun karşıt-tonal okuma deneyi); 2. dönem 5/7 olur. **Süreç dersi:** v0.10.1 = atomik altyapı disiplininin ilk büyük testi (önceki turlarda 3 atomik vardı v0.4'te, bu turda 20 birden eklendi). Üç ders: (1) Toplu inşa, dağınık inşadan daha verimli — slug-disiplin tutarlılığı tek-seferde sağlandı, çoklu-kitap cross-ref'leri (Bağdat 6, Tercüme Hareketi 5, Bîrûnî 4) birbiriyle uyumlu deklare edildi. (2) "Aktif yorumlu cross-ref" stub-disiplinini esnetir (gövde +200 kelime ortalama) ama "atomik atlas wiki-tarzı tek-yorumlu girdiden ayrılır" pedagojik vaadinin formel-yapısal kanıtı. (3) İleri-cross-ref hazırlığı stratejik bir disiplin — bugün tek-cross-ref'li 14 atomik, 3.-4. dönem kitaplarında (Westfall, Cohen, Eisenstein, Berkey, Gutas, İhsanoğlu) cross-ref ağına eklemlenecek; atomikler bugünün cross-ref ağı için değil müfredatın **ileride**ki cross-ref taleplerine hazırlık olarak inşa edilebilir. |
---
