...
> **Versiyon:** v0.8.2 — Faz 2 Kol A (feedback hızlı uyum) tamamlandı: HALKA-FEEDBACK-v0.8 maddelerinden 4'ü kapatıldı (F1.6 stratejik okuma her kitaba, F1.7 akıcılık etiketi 3 renkli chip + tooltip, F1.8 içindekiler ilk kısımda, F2.5 tartışma soruları yukarıda + spoiler uyarı kutusu); şemaya 4 yeni alan eklendi (`reading_level`, `accessibility_note`, `cover_image`, `cover_credit`) — Hobson'dan beri ilk şema değişikliği; sıfırdan README + hibrit lisans (MIT kod + CC BY-SA 4.0 içerik, Wikipedia modeli); Fara'da iki Pedersen konflasyonu bug-fix; v0.8.1 — Faz 0 KAPANDI: alicetinkaya76.github.io/halka canlıda; v0.8 — Fara açılış kitabı + 60 atomik tartışma sorusu, 1. dönem 6/6 = TAM (6/21 kitap toplam).
