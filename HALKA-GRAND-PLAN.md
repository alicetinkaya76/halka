...
> **Versiyon:** v0.8.1 — Faz 0 KAPANDI: alicetinkaya76.github.io/halka canlıda. v0.8 — Fara *Bilim: Dört Bin Yıllık Bir Tarih* açılış kitabı eklendi (1. dönem #1); 4 kitabın discussion_questions toplu revizyonu (8→10 standardizasyon); 6 kitap × 10 soru = 60 atomik tartışma sorusu; 25 Nisan tutanağı stub'ı bilinçli olarak atlandı, yöntemsel revizyon içsel akademik yargıyla yapıldı (6/21 kitap toplam, 1. dönem 6/6 = TAM).
